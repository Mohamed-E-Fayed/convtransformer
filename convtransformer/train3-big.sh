...
MODELSIZE=transformer_wide
DATAPATH=/mnt/az_file_share/fayed/data/${src}-${tgt}/preprocessed
SAVEDIR=checkpoints_3_${src}_${tgt}
...
--update-freq 4    --max-epoch 5  \
  --max-tokens 2048 --memory-efficient-fp16  --fp16-scale-tolerance=0.25  --min-loss-scale=1   \
